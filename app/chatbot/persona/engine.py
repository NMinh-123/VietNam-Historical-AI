...
if TYPE_CHECKING:
    from app.chatbot.engine import VietnamHistoryQueryEngine

from .config import PersonaConfig, check_temporal_guardrail
from app.core.prompts.prompt_templates import (
