...
DEFAULT_CHUNK_ID_REGISTRY_PATH = CURRENT_DIR.parent.parent / "app" / "data" / "chunk_id_registry.json"

from src.utils.helpers import clean_text, clean_documents  # noqa: E402
